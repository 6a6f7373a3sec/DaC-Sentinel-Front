...
const StatCard = ({ title, value, icon: Icon, color }: { title: string, value: string | number, icon: any, color: string }) => (
  <div className="bg-a3sec-surface p-6 rounded-xl shadow-sm border border-a3sec-border flex items-center">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Total de reglas" value={summary.total_rules} icon={FileText} color="bg-brand-green text-a3sec-dark" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-a3sec-surface p-6 rounded-xl shadow-sm border border-a3sec-border">
          <h2 className="text-lg font-semibold mb-4 text-white">Reglas por nivel de severidad</h2>
          <div className="h-64">
        ...
        <div className="bg-a3sec-surface p-6 rounded-xl shadow-sm border border-a3sec-border">
          <h2 className="text-lg font-semibold mb-4 text-white">Top Data Sources (Productos)</h2>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={productData} layout="vertical">
                ...
                <Bar dataKey="value" fill="#99D1C5" radius={[0, 4, 4, 0]} barSize={20} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
